...
def main():
    ...
    # include_length save sentence's length
    # batch_first X*y*z（X为batch_first，y represent sentence's length, z glo function, words matix）
    ...
    # use_vocab: 0/1 use_vocab 不用做单词转数字的处理
    # is_target：告诉计算机是个label
